...
Maintainers have the right and responsibility to remove, edit, or reject comments, commits, issues, discussions, and other contributions that are not aligned with this Code of Conduct, and will communicate reasons for moderation decisions when appropriate.

---

## Scope

This Code of Conduct applies within all community spaces, including this repository, its Issues, Discussions, and Pull Requests, and also applies when an individual is officially representing the community in public spaces.
...
**2. Warning** — A warning with consequences for continued behavior. The person must not interact with the people involved, including unsolicited interaction with those enforcing the Code of Conduct, for a specified period of time.
